...
- **Screenshot images**: Images you select for travel destination analysis
- **Travel and place information**: Trip names, destination names, memos, schedules, and other information you enter
...
- Automatically analyzing travel destinations from screenshots using AI
...
The App uses the following third-party services. Your data may be processed in accordance with each service's own privacy policy.

### Anthropic (Claude Vision API)
- **Data sent**: Screenshot images selected by the user
- **Purpose**: Automatic analysis and extraction of travel destination information from images
- **Anthropic Privacy Policy**: https://www.anthropic.com/privacy

### Google (Places API)
- **Data sent**: Text data such as place names and addresses
- **Purpose**: Retrieving destination details, displaying maps, and fetching photos
- **Google Privacy Policy**: https://policies.google.com/privacy

### Supabase
- **Data sent**: Account information, travel data, destination information, and evaluation data
...
- **Right of access**: You may request disclosure of your personal data
- **Right of rectification**: You may request correction of inaccurate data (you can also edit information directly within the App)
- **Right to erasure**: You can delete all your data at any time using the "Delete Account" feature within the App
